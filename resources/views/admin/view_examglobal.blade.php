        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <a href="{{ route('admin.exams.create')}}" class="px-3 py-1.5 bg-green-600 text-white text-sm font-medium rounded hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-green-500 transition" >+ Tambah</a>    <x-input-error :messages="$errors->get('error')" class="mb-4" />
                            ...
                            @forelse ($exams as $exam)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 border">
                                        <a href="{{ route('admin.grades.edit', $exam->id) }}" class="btn btn-primary">Edit</a>
