                                                        ...
                                                        <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
                                                            <div class="flex space-x-2">
                                                                ...
                                                                <form action="{{route('admin.siswa.destroy', $exam->id)}}" method="POST" class="inline-block">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit" class="px-3 py-2 text-sm font-medium text-white transition bg-red-600 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500" onclick="return confirm('Apakah Anda yakin ingin menghapus siswa ini?')">Hapus</button>
                                                                </form>
                                                            </div>
                                                        </tr>
                                                        @empty
