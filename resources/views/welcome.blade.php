    ...
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-4">
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="inline-block px-5 py-1.5 text-white bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 rounded-sm text-sm leading-normal font-medium transition-colors">
                        Log in
                    </a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="inline-block px-5 py-1.5 text-indigo-600 bg-white hover:bg-indigo-50 border-2 border-indigo-600 hover:border-indigo-700 rounded-sm text-sm leading-normal font-medium transition-colors">
                            Register
                        </a>
                    @endif
                @endauth
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium text-xl">Selamat Datang di CBT App</h1>
                <p class="mb-4 text-[#706f6c]">Sistem Computer Based Test untuk ujian online yang mudah dan efisien.</p>

                <div class="mb-6">
                    <h2 class="font-medium mb-3 text-base">Fitur Utama:</h2>
                    <ul class="flex flex-col gap-2">
                        <li class="flex items-start gap-3 py-2">
                            <span
                                class="flex items-center justify-center rounded-full bg-blue-100 w-6 h-6 mt-0.5 flex-shrink-0">
                            ...
                            <span>
                                <strong>Manajemen Ujian</strong> - Buat dan kelola berbagai jenis ujian dengan mudah
                            </span>
                        </li>
                        <li class="flex items-start gap-3 py-2">
                            <span
                                class="flex items-center justify-center rounded-full bg-green-100 w-6 h-6 mt-0.5 flex-shrink-0">
                            ...
                            <span>
                                <strong>Bank Soal</strong> - Kelola soal dengan berbagai tipe (pilihan ganda, essay,
                                dll)
                            </span>
                        </li>
                        <li class="flex items-start gap-3 py-2">
                            <span
                                class="flex items-center justify-center rounded-full bg-purple-100 w-6 h-6 mt-0.5 flex-shrink-0">
                            ...
                            <span>
                                <strong>Penilaian Otomatis</strong> - Sistem penilaian otomatis untuk efisiensi waktu
                            </span>
                        </li>
                        <li class="flex items-start gap-3 py-2">
                            <span
                                class="flex items-center justify-center rounded-full bg-orange-100 w-6 h-6 mt-0.5 flex-shrink-0">
                            ...
                            <span>
                                <strong>Laporan & Statistik</strong> - Dashboard lengkap untuk monitoring hasil ujian
                            </span>
                        </li>
                    </ul>
                </div>

                <div class="text-sm text-[#706f6c] mt-6">
                    <p>Silakan login untuk mengakses sistem sesuai dengan role Anda.</p>
                </div>
            </div>
            <div
                class="bg-gradient-to-br from-blue-50 to-indigo-100 relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">
                {{-- CBT App Illustration --}}
                <div class="text-center px-8">
                    <svg class="w-32 h-32 mx-auto mb-4 text-indigo-600" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                        </path>
                    </svg>
                    <h2 class="text-3xl font-bold text-indigo-900 mb-2">CBT App</h2>
                    <p class="text-indigo-700 text-sm">Computer Based Test System</p>
                </div>
                <!-- Laravel SVG removed -->
                ...
                {{-- SVG decoration removed for cleaner look --}}
