...
<body>
    ...
    <table border=1 class="data-table" style="border: solid 1px black; border-collapse: collapse; width: 100%;">
        {{-- <thead>
            <tr>
        ...
        <tbody>
            @foreach($beritaAcara->pengawas as $index => $namaPengawas)
                ...
                <tr>
                    <td style="text-align: center; border: none; padding: 5px 0;" width="35%">
                        Pengawas {{ $index + 1 }} :
                    </td>
