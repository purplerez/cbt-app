                    ...
                    <form method="POST" action="{{ route('kepala.berita-acara.store') }}" id="beritaAcaraForm">
                            ...
                            <div>
                                ...
                                <select name="exam_id" id="exam_id"
                                    ...
                                    @foreach($exams as $exam)
                                        <option value="{{ $exam->id }}" data-exam-type="{{ $exam->exam_type_id }}" {{ old('exam_id') == $exam->id ? 'selected' : '' }}>
                                            {{ $exam->title }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-700">
                                 Inputkan Pengawas dan Proktor
                            </label>
                            <div class="space-y-3">
                                <div>
                                    <label for="pengawas_1" class="block mb-1 text-xs font-medium text-gray-600">
                                        Pengawas
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label for="pengawas_2" class="block mb-1 text-xs font-medium text-gray-600">
                                        Proktor
                                    </label>
                                    <input
                                        type="text"
                                        name="pengawas[]"
                                        id="pengawas_2"
                                        placeholder="Masukkan nama proktor"
                                        class="block w-full text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    >
                                </div>
